...
| ---------- |-------------------------------------------|-------------------------------------------------------|
| `CarPark`    | Max Bays, Ocuppied Bays, Plates, Displays | Add Car, Remove Car, Register Display, Publish Status |
| `Sensor`     | Car Park                                  | Detect Car, Update Car Park                           |
| `Display`    | Temperature, Available Bays               | Display Board                                         |
...
> It should be tested in the Car Park unit test because it is a method of the Car Park class. 
